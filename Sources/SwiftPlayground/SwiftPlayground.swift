    ...
    func writeData(tableChosen: String, dbQueue: DatabaseQueue) {
        ...
        case menuButtons[2]:
            do {
                ...
                try dbQueue.write { db in
                    ...
                    Phone must be below 15 characters.
                    Email must be below 30 characters.
                    """)
                }
            } catch {
                print(error)
        ...
        case menuButtons[3]:
            do {
                ...
                if intCopiesTyped > 0 && intCopiesTyped <= 99 && titleTyped.count > 0 && authorTyped.count > 0 &&
                titleTyped.count <= 30 && authorTyped.count <= 30 {
                    // Attempt to read and display the data of the books table, ordered by id.
                    try dbQueue.write { db in
                        let newBook = Book(
